  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden lg:h-screen lg:overflow-hidden noise-overlay">
      ...
      <div className="pointer-events-none fixed inset-0 z-0">
        ...
        <div className="absolute -top-40 -left-40 h-[480px] w-[480px] rounded-full bg-blue-600/8 blur-[140px]" />
        <div className="absolute -bottom-40 -right-40 h-[480px] w-[480px] rounded-full bg-purple-600/8 blur-[140px]" />
        <div className="absolute top-1/3 right-1/4 h-[400px] w-[400px] rounded-full bg-gold/5 blur-[160px]" />
      </div>
        ...
        <div className="flex h-full flex-col gap-3 sm:gap-4 lg:flex-row lg:gap-5">
          ...
          >
            <div className="flex items-center justify-between border-b border-border bg-card/20 px-5 py-3 shrink-0">
              <span className="font-sora text-sm font-medium text-white/90">
                {SECTION_LABELS[activeSection]}
              </span>
              <span className="text-[11px] text-muted/60 font-inter hidden sm:block">
                nathan-portifolio.vercel.app
              </span>
            </div>

            <div className="sticky top-0 z-20 shrink-0 border-b border-border/50 bg-panel/90 backdrop-blur-xl px-3 pt-2 pb-2 sm:px-5 sm:pt-3 sm:pb-3 lg:static lg:top-auto">
              {topbar}
            </div>

            <main
              ref={scrollRef}
              className="main-scroll flex-1 px-4 pb-6 sm:px-5 lg:overflow-y-auto lg:overscroll-contain lg:px-8 lg:pb-8"
            >
              {children}
            </main>
