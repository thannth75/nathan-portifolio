...
import { CV_URL, PROFILE, SOCIAL_LINKS } from '../../data/content'
        ...
        >
          <div className="flex w-full flex-col items-center gap-4 sm:flex-row sm:items-center sm:text-left lg:flex-col lg:text-center">
            <div className="relative shrink-0">
              <div className="absolute -inset-2 rounded-full bg-gradient-to-br from-gold/15 via-purple-500/8 to-blue-500/8 blur-xl" />
              {avatarError ? (
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-2 text-xs text-muted font-inter leading-relaxed">
                {PROFILE.tagline}
              </p>
            </div>
          </div>
